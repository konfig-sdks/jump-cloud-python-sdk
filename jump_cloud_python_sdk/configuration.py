...
from jump_cloud_python_sdk.exceptions_base import ApiValueError
from jump_cloud_python_sdk.exceptions import ClientConfigurationError
from jump_cloud_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = jump_cloud_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://console.jumpcloud.com/api/v2" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if x_api_key:
            self.api_key['x-api-key'] = x_api_key
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("jump_cloud_python_sdk")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://console.jumpcloud.com/api/v2",
