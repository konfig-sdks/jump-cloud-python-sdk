...
from jump_cloud_python_sdk.model.policyresults_list_response import PolicyresultsListResponse as PolicyresultsListResponseSchema

from jump_cloud_python_sdk.type.policyresults_list_response import PolicyresultsListResponse

from ...api_client import Dictionary
from jump_cloud_python_sdk.pydantic.policyresults_list_response import PolicyresultsListResponse as PolicyresultsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PolicyresultsListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PolicyresultsListResponse
    ...
    async def _alist_0_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/policies/{policy_id}/policyresults',
            auth_settings=_auth,
            headers=_headers,
        )
...
class List0(BaseApi):
    ...
    async def alist_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PolicyresultsListResponsePydantic:
        ...
        if validate:
            return RootModel[PolicyresultsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(PolicyresultsListResponsePydantic, raw_response.body)
