...
from jump_cloud_python_sdk.model.device_package_v1_list_devices_response import DevicePackageV1ListDevicesResponse as DevicePackageV1ListDevicesResponseSchema

from jump_cloud_python_sdk.type.google_rpc_status import GoogleRpcStatus
from jump_cloud_python_sdk.type.device_package_v1_list_devices_response import DevicePackageV1ListDevicesResponse

from ...api_client import Dictionary
from jump_cloud_python_sdk.pydantic.device_package_v1_list_devices_response import DevicePackageV1ListDevicesResponse as DevicePackageV1ListDevicesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DevicePackageV1ListDevicesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DevicePackageV1ListDevicesResponse
    ...
    async def _alist_devices_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/passwordmanager/devices',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListDevices(BaseApi):
    ...
    async def alist_devices(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DevicePackageV1ListDevicesResponsePydantic:
        ...
        if validate:
            return DevicePackageV1ListDevicesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DevicePackageV1ListDevicesResponsePydantic, raw_response.body)
