    ...
    async def _aerase_device_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/google-emm/devices/{deviceId}/erase-device',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class EraseDeviceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aerase_device(
        self,
        device_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._erase_device_mapped_args(
            device_id=device_id,
        )
        return await self._aerase_device_oapg(
            body=args.body,
    ...
    def erase_device(
        ...
        return self._erase_device_oapg(
            body=args.body,
            path_params=args.path,
        )

class EraseDevice(BaseApi):
    ...
    async def aerase_device(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aerase_device(
            device_id=device_id,
            **kwargs,
        )
        if validate:
    ...
    def erase_device(
        ...
        raw_response = self.raw.erase_device(
            device_id=device_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
