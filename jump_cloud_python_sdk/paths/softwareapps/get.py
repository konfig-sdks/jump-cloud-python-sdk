...
from jump_cloud_python_sdk.model.software_apps_list_response import SoftwareAppsListResponse as SoftwareAppsListResponseSchema

from jump_cloud_python_sdk.type.software_apps_list_response import SoftwareAppsListResponse

from ...api_client import Dictionary
from jump_cloud_python_sdk.pydantic.software_apps_list_response import SoftwareAppsListResponse as SoftwareAppsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = SoftwareAppsListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SoftwareAppsListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SoftwareAppsListResponsePydantic:
        ...
        if validate:
            return RootModel[SoftwareAppsListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(SoftwareAppsListResponsePydantic, raw_response.body)
