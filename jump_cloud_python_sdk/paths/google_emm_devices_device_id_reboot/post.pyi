...
class BaseApi(api_client.Api):
    ...
    def _reboot_device_mapped_args(
        self,
        device_id: str,
    ...
    async def _areboot_device_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/google-emm/devices/{deviceId}/reboot',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class RebootDeviceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areboot_device(
        self,
        device_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._reboot_device_mapped_args(
            device_id=device_id,
        )
        return await self._areboot_device_oapg(
            body=args.body,
...
class RebootDevice(BaseApi):
    ...
    async def areboot_device(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areboot_device(
            device_id=device_id,
            **kwargs,
        )
        if validate:
    ...
    def reboot_device(
        ...
        raw_response = self.raw.reboot_device(
            device_id=device_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
