...
from jump_cloud_python_sdk.model.workdays_list_response import WorkdaysListResponse as WorkdaysListResponseSchema

from jump_cloud_python_sdk.type.workdays_list_response import WorkdaysListResponse

from ...api_client import Dictionary
from jump_cloud_python_sdk.pydantic.workdays_list_response import WorkdaysListResponse as WorkdaysListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = WorkdaysListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: WorkdaysListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[WorkdaysListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(WorkdaysListResponsePydantic, raw_response.body)
