...
class BaseApi(api_client.Api):
    ...
    def _revoke_access_request_mapped_args(
        self,
        access_id: str,
    ...
    async def _arevoke_access_request_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/accessrequests/{accessId}/revoke',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _revoke_access_request_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RevokeAccessRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arevoke_access_request(
        self,
        access_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._revoke_access_request_mapped_args(
            access_id=access_id,
        )
        return await self._arevoke_access_request_oapg(
    ...
    def revoke_access_request(
        ...
        return self._revoke_access_request_oapg(
            path_params=args.path,
        )

class RevokeAccessRequest(BaseApi):
    ...
    async def arevoke_access_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arevoke_access_request(
            access_id=access_id,
            **kwargs,
        )
        if validate:
    ...
    def revoke_access_request(
        ...
        raw_response = self.raw.revoke_access_request(
            access_id=access_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
