    ...
    async def _alock_device_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/google-emm/devices/{deviceId}/lock',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class LockDeviceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alock_device(
        self,
        device_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._lock_device_mapped_args(
            device_id=device_id,
        )
        return await self._alock_device_oapg(
            body=args.body,
    ...
    def lock_device(
        ...
        return self._lock_device_oapg(
            body=args.body,
            path_params=args.path,
        )

class LockDevice(BaseApi):
    ...
    async def alock_device(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alock_device(
            device_id=device_id,
            **kwargs,
        )
        if validate:
    ...
    def lock_device(
        ...
        raw_response = self.raw.lock_device(
            device_id=device_id,
        )
        if validate:
            return Dictionary(**raw_response.body)
