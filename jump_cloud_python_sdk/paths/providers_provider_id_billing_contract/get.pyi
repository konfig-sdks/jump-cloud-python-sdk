...
SchemaFor0ResponseBodyApplicationPdf = GoogleRpcStatusSchema
...
_response_for_default = api_client.OpenApiResponse(
    ...
    content={
        'application/pdf': api_client.MediaType(
            schema=SchemaFor0ResponseBodyApplicationPdf),
    },
)
    ...
    async def _aget_contract_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/providers/{provider_id}/billing/contract',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetContractRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_contract(
        self,
        provider_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_contract_mapped_args(
            provider_id=provider_id,
        )
        return await self._aget_contract_oapg(
...
class GetContract(BaseApi):
    ...
    async def aget_contract(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_contract(
            provider_id=provider_id,
            **kwargs,
        )
        if validate:
    ...
    def get_contract(
        ...
        raw_response = self.raw.get_contract(
            provider_id=provider_id,
        )
        if validate:
            return RootModel[typing.IO](raw_response.body).root
