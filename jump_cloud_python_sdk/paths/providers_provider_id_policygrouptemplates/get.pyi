...
from jump_cloud_python_sdk.model.policy_group_templates import PolicyGroupTemplates as PolicyGroupTemplatesSchema

from jump_cloud_python_sdk.type.policy_group_templates import PolicyGroupTemplates
...
from jump_cloud_python_sdk.pydantic.policy_group_templates import PolicyGroupTemplates as PolicyGroupTemplatesPydantic
...
SchemaFor200ResponseBodyApplicationJson = PolicyGroupTemplatesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PolicyGroupTemplates
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/providers/{provider_id}/policygrouptemplates',
            auth_settings=_auth,
            headers=_headers,
        )
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return PolicyGroupTemplatesPydantic(**raw_response.body)
        return api_client.construct_model_instance(PolicyGroupTemplatesPydantic, raw_response.body)
