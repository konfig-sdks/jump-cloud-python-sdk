...
class BaseApi(api_client.Api):
    ...
    def _download_config_files_mapped_args(
        self,
    ...
    async def _adownload_config_files_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/microsoft-mdm/configuration-files',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _download_config_files_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DownloadConfigFilesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adownload_config_files(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._download_config_files_mapped_args(
        )
        return await self._adownload_config_files_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def download_config_files(
        ...
        return self._download_config_files_oapg(
            body=args.body,
        )

class DownloadConfigFiles(BaseApi):
    ...
    async def adownload_config_files(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adownload_config_files(
            **kwargs,
        )
        if validate:
    ...
    def download_config_files(
        ...
        raw_response = self.raw.download_config_files(
        )
        if validate:
            return RootModel[typing.IO](raw_response.body).root
        return raw_response.body
