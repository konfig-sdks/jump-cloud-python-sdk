...
from jump_cloud_python_sdk.model.o365_domains_list_response import O365DomainsListResponse as O365DomainsListResponseSchema

from jump_cloud_python_sdk.type.google_rpc_status import GoogleRpcStatus
from jump_cloud_python_sdk.type.o365_domains_list_response import O365DomainsListResponse
...
from jump_cloud_python_sdk.pydantic.o365_domains_list_response import O365DomainsListResponse as O365DomainsListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = O365DomainsListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: O365DomainsListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> O365DomainsListResponsePydantic:
        ...
        if validate:
            return O365DomainsListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(O365DomainsListResponsePydantic, raw_response.body)
