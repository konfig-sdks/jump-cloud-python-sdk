...
from jump_cloud_python_sdk.model.ldapservers_list_response import LdapserversListResponse as LdapserversListResponseSchema

from jump_cloud_python_sdk.type.ldapservers_list_response import LdapserversListResponse

from ...api_client import Dictionary
from jump_cloud_python_sdk.pydantic.ldapservers_list_response import LdapserversListResponse as LdapserversListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = LdapserversListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: LdapserversListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> LdapserversListResponsePydantic:
        ...
        if validate:
            return RootModel[LdapserversListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(LdapserversListResponsePydantic, raw_response.body)
