...
from jump_cloud_python_sdk.model.activedirectories_list_response import ActivedirectoriesListResponse as ActivedirectoriesListResponseSchema

from jump_cloud_python_sdk.type.activedirectories_list_response import ActivedirectoriesListResponse

from ...api_client import Dictionary
from jump_cloud_python_sdk.pydantic.activedirectories_list_response import ActivedirectoriesListResponse as ActivedirectoriesListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ActivedirectoriesListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ActivedirectoriesListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ActivedirectoriesListResponsePydantic:
        ...
        if validate:
            return RootModel[ActivedirectoriesListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ActivedirectoriesListResponsePydantic, raw_response.body)
