...
from jump_cloud_python_sdk.model.jumpcloud_msp_get_details_response import JumpcloudMspGetDetailsResponse as JumpcloudMspGetDetailsResponseSchema

from jump_cloud_python_sdk.type.google_rpc_status import GoogleRpcStatus
from jump_cloud_python_sdk.type.jumpcloud_msp_get_details_response import JumpcloudMspGetDetailsResponse
...
from jump_cloud_python_sdk.pydantic.jumpcloud_msp_get_details_response import JumpcloudMspGetDetailsResponse as JumpcloudMspGetDetailsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = JumpcloudMspGetDetailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: JumpcloudMspGetDetailsResponse
    ...
    async def _aget_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/providers/{provider_id}/billing/details',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> JumpcloudMspGetDetailsResponsePydantic:
        raw_response = await self.raw.aget_details(
            provider_id=provider_id,
            **kwargs,
        )
        if validate:
            return JumpcloudMspGetDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(JumpcloudMspGetDetailsResponsePydantic, raw_response.body)
