...
from jump_cloud_python_sdk.model.import_users_response import ImportUsersResponse as ImportUsersResponseSchema

from jump_cloud_python_sdk.type.import_users_response import ImportUsersResponse

from ...api_client import Dictionary
from jump_cloud_python_sdk.pydantic.import_users_response import ImportUsersResponse as ImportUsersResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ImportUsersResponseSchema
    ...
    async def _ausers_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/applications/{application_id}/import/users',
            auth_settings=_auth,
            headers=_headers,
        )
...
class Users(BaseApi):
    ...
    async def ausers(
        ...
        **kwargs,
        ...
        if validate:
            return ImportUsersResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ImportUsersResponsePydantic, raw_response.body)
