...
from jump_cloud_python_sdk.model.user_groups_get_suggestions_response import UserGroupsGetSuggestionsResponse as UserGroupsGetSuggestionsResponseSchema

from jump_cloud_python_sdk.type.user_groups_get_suggestions_response import UserGroupsGetSuggestionsResponse

from ...api_client import Dictionary
from jump_cloud_python_sdk.pydantic.user_groups_get_suggestions_response import UserGroupsGetSuggestionsResponse as UserGroupsGetSuggestionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = UserGroupsGetSuggestionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: UserGroupsGetSuggestionsResponse
...
class GetSuggestions(BaseApi):
    ...
    async def aget_suggestions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> UserGroupsGetSuggestionsResponsePydantic:
        ...
        if validate:
            return RootModel[UserGroupsGetSuggestionsResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(UserGroupsGetSuggestionsResponsePydantic, raw_response.body)
