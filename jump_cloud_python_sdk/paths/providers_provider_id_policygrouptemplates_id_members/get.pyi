...
from jump_cloud_python_sdk.model.policy_group_template_members import PolicyGroupTemplateMembers as PolicyGroupTemplateMembersSchema
from jump_cloud_python_sdk.model.error_details import ErrorDetails as ErrorDetailsSchema

from jump_cloud_python_sdk.type.policy_group_template_members import PolicyGroupTemplateMembers
...
from jump_cloud_python_sdk.pydantic.policy_group_template_members import PolicyGroupTemplateMembers as PolicyGroupTemplateMembersPydantic
...
SchemaFor200ResponseBodyApplicationJson = PolicyGroupTemplateMembersSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PolicyGroupTemplateMembers
    ...
    async def _alist_members_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/providers/{provider_id}/policygrouptemplates/{id}/members',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListMembers(BaseApi):
    ...
    async def alist_members(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PolicyGroupTemplateMembersPydantic:
        ...
        if validate:
            return PolicyGroupTemplateMembersPydantic(**raw_response.body)
        return api_client.construct_model_instance(PolicyGroupTemplateMembersPydantic, raw_response.body)
