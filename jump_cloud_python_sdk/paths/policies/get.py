...
from jump_cloud_python_sdk.model.policies_list_response import PoliciesListResponse as PoliciesListResponseSchema

from jump_cloud_python_sdk.type.error import Error
from jump_cloud_python_sdk.type.policies_list_response import PoliciesListResponse

from ...api_client import Dictionary
from jump_cloud_python_sdk.pydantic.policies_list_response import PoliciesListResponse as PoliciesListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PoliciesListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PoliciesListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[PoliciesListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(PoliciesListResponsePydantic, raw_response.body)
