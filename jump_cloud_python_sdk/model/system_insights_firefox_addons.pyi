...
class SystemInsightsFirefoxAddons(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "version", "active", "autoupdate", "collection_time", "creator", "disabled", "identifier", "location", "name", "path", "source_url", "system_id", "type", "uid", "visible", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "version", "active", "autoupdate", "collection_time", "creator", "disabled", "identifier", "location", "name", "path", "source_url", "system_id", "type", "uid", "visible", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        autoupdate: typing.Union[MetaOapg.properties.autoupdate, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ...
        visible: typing.Union[MetaOapg.properties.visible, decimal.Decimal, int, schemas.Unset] = schemas.unset,
