...
class JumpcloudGappsDomainListResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class domains(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JumpcloudGappsDomain']:
                        return JumpcloudGappsDomain
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['JumpcloudGappsDomain'], typing.List['JumpcloudGappsDomain']],
                ...
                def __getitem__(self, i: int) -> 'JumpcloudGappsDomain':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["domains", "totalCount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["domains", "totalCount", ], str]):
