...
class ConnectwiseRetrieveAgreementsResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ConnectwiseAgreement']:
                        return ConnectwiseAgreement
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ConnectwiseAgreement'], typing.List['ConnectwiseAgreement']],
                ...
                def __getitem__(self, i: int) -> 'ConnectwiseAgreement':
