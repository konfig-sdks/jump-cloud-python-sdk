...
class PhoneNumber(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "number", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "number", "type", ], str]):
