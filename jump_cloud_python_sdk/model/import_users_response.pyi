...
class ImportUsersResponse(
        ...
        class properties:
            ...
            class users(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ImportUser']:
                        return ImportUser
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ImportUser'], typing.List['ImportUser']],
                ...
                def __getitem__(self, i: int) -> 'ImportUser':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total_count", "users", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total_count", "users", ], str]):
