...
class ActiveDirectoryAgentList(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "contactAt", "hostname", "id", "source_ip", "state", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version", "contactAt", "hostname", "id", "source_ip", "state", ], str]):
