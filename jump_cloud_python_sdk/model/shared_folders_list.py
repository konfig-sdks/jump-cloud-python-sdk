        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['SharedFolder']:
                        return SharedFolder
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['SharedFolder'], typing.List['SharedFolder']],
                ...
                def __getitem__(self, i: int) -> 'SharedFolder':
