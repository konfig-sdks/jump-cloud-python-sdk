...
class IntegrationSyncErrorResp(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class records(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['IntegrationSyncError']:
                        return IntegrationSyncError
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['IntegrationSyncError'], typing.List['IntegrationSyncError']],
                ...
                def __getitem__(self, i: int) -> 'IntegrationSyncError':
