...
class SystemInsightsDnsResolvers(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address", "collection_time", "id", "netmask", "options", "system_id", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address", "collection_time", "id", "netmask", "options", "system_id", "type", ], str]):
