...
class QueuedCommandListResultsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            pendingCount = schemas.IntSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["command", "id", "pendingCount", "system", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["command", "id", "pendingCount", "system", ], str]):
