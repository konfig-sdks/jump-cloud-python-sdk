...
class ObjectStorageItem(
        ...
        class properties:
            ...
            class versions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ObjectStorageVersion']:
                        return ObjectStorageVersion
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ObjectStorageVersion'], typing.List['ObjectStorageVersion']],
                ...
                def __getitem__(self, i: int) -> 'ObjectStorageVersion':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["objectId", "versions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["objectId", "versions", ], str]):
