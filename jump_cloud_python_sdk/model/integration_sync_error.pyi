...
class IntegrationSyncError(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errorType", "message", "orgId", "timestamp", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errorType", "message", "orgId", "timestamp", ], str]):
