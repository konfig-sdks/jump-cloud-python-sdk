...
* `user_password` - Translate JumpCloud user `password` to G Suite Directory user `password`
    ...
    class MetaOapg:
        enum_value_to_name = {
            "user_home_addresses": "HOME_ADDRESSES",
            "user_work_addresses": "WORK_ADDRESSES",
            "user_other_addresses": "OTHER_ADDRESSES",
            "user_home_phone_numbers": "HOME_PHONE_NUMBERS",
            "user_mobile_phone_numbers": "MOBILE_PHONE_NUMBERS",
            "user_other_phone_numbers": "OTHER_PHONE_NUMBERS",
            "user_work_phone_numbers": "WORK_PHONE_NUMBERS",
            "user_work_fax_phone_numbers": "WORK_FAX_PHONE_NUMBERS",
            "user_work_mobile_phone_numbers": "WORK_MOBILE_PHONE_NUMBERS",
            "user_manager": "MANAGER",
            "user_alternate_email": "ALTERNATE_EMAIL",
            "user_primary_organization_cost_center": "PRIMARY_ORGANIZATION_COST_CENTER",
            "user_primary_organization_department": "PRIMARY_ORGANIZATION_DEPARTMENT",
            "user_primary_organization_description": "PRIMARY_ORGANIZATION_DESCRIPTION",
            "user_primary_organization_employee_id": "PRIMARY_ORGANIZATION_EMPLOYEE_ID",
            "user_primary_organization_title": "PRIMARY_ORGANIZATION_TITLE",
            "user_status": "STATUS",
            "user_password": "PASSWORD",
        }
    
    @schemas.classproperty
    def HOME_ADDRESSES(cls):
        return cls("user_home_addresses")
    
    @schemas.classproperty
    def WORK_ADDRESSES(cls):
        return cls("user_work_addresses")
    
    @schemas.classproperty
    def OTHER_ADDRESSES(cls):
        return cls("user_other_addresses")
    
    @schemas.classproperty
    def HOME_PHONE_NUMBERS(cls):
        return cls("user_home_phone_numbers")
    
    @schemas.classproperty
    def MOBILE_PHONE_NUMBERS(cls):
        return cls("user_mobile_phone_numbers")
    
    @schemas.classproperty
    def OTHER_PHONE_NUMBERS(cls):
        return cls("user_other_phone_numbers")
    
    @schemas.classproperty
    def WORK_PHONE_NUMBERS(cls):
        return cls("user_work_phone_numbers")
    
    @schemas.classproperty
    def WORK_FAX_PHONE_NUMBERS(cls):
        return cls("user_work_fax_phone_numbers")
    
    @schemas.classproperty
    def WORK_MOBILE_PHONE_NUMBERS(cls):
        return cls("user_work_mobile_phone_numbers")
    ...
    @schemas.classproperty
    def ALTERNATE_EMAIL(cls):
        return cls("user_alternate_email")
    
    @schemas.classproperty
    def PRIMARY_ORGANIZATION_COST_CENTER(cls):
        return cls("user_primary_organization_cost_center")
    
    @schemas.classproperty
    def PRIMARY_ORGANIZATION_DEPARTMENT(cls):
        return cls("user_primary_organization_department")
    
    @schemas.classproperty
    def PRIMARY_ORGANIZATION_DESCRIPTION(cls):
        return cls("user_primary_organization_description")
    
    @schemas.classproperty
    def PRIMARY_ORGANIZATION_EMPLOYEE_ID(cls):
        return cls("user_primary_organization_employee_id")
    
    @schemas.classproperty
    def PRIMARY_ORGANIZATION_TITLE(cls):
        return cls("user_primary_organization_title")
