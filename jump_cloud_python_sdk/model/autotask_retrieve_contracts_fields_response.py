...
class AutotaskRetrieveContractsFieldsResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AutotaskContractField']:
                        return AutotaskContractField
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['AutotaskContractField'], typing.List['AutotaskContractField']],
                ...
                def __getitem__(self, i: int) -> 'AutotaskContractField':
