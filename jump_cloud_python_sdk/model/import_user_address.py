...
class ImportUserAddress(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["country", "locality", "postalCode", "region", "streetAddress", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["country", "locality", "postalCode", "region", "streetAddress", "type", ], str]):
