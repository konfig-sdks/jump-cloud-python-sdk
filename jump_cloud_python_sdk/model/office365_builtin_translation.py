...
* `user_street_address` - Translate `streetAddress` field of JumpCloud user address of type `work` to `streetAddress` field of Microsoft Graph user
    ...
    class MetaOapg:
        enum_value_to_name = {
            ...
            "user_business_phones": "BUSINESS_PHONES",
            "user_city": "CITY",
            ...
            "user_office_location": "OFFICE_LOCATION",
            "user_postal_code": "POSTAL_CODE",
            "user_principal_name_from_alternate_email": "PRINCIPAL_NAME_FROM_ALTERNATE_EMAIL",
            "user_state": "STATE",
    ...
    @schemas.classproperty
    def BUSINESS_PHONES(cls):
        return cls("user_business_phones")
    
    @schemas.classproperty
    def CITY(cls):
        return cls("user_city")
    
    @schemas.classproperty
    def COUNTRY(cls):
        return cls("user_country")
    
    @schemas.classproperty
    def DEPARTMENT(cls):
        return cls("user_department")
    
    @schemas.classproperty
    def JOB_TITLE(cls):
        return cls("user_job_title")
    ...
    def MOBILE_PHONE(cls):
        return cls("user_mobile_phone")
    
    @schemas.classproperty
    def OFFICE_LOCATION(cls):
        return cls("user_office_location")
    
    @schemas.classproperty
    def POSTAL_CODE(cls):
        return cls("user_postal_code")
    
    @schemas.classproperty
    def PRINCIPAL_NAME_FROM_ALTERNATE_EMAIL(cls):
        return cls("user_principal_name_from_alternate_email")
    
    @schemas.classproperty
    def STATE(cls):
        return cls("user_state")
    
    @schemas.classproperty
    def STREET_ADDRESS(cls):
        return cls("user_street_address")
