...
class User(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["addresses", "alternateEmail", "company", "costCenter", "department", "email", "employeeIdentifier", "employeeType", "firstname", "jobTitle", "lastname", "location", "phoneNumbers", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["addresses", "alternateEmail", "company", "costCenter", "department", "email", "employeeIdentifier", "employeeType", "firstname", "jobTitle", "lastname", "location", "phoneNumbers", ], str]):
