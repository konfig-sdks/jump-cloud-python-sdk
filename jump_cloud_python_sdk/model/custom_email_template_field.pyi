...
class CustomEmailTemplateField(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["defaultValue", "displayName", "field", "multiline", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["defaultValue", "displayName", "field", "multiline", ], str]):
