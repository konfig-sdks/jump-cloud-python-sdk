...
class ConnectwiseCompanyTypeResp(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class records(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['BillingIntegrationCompanyType']:
                        return BillingIntegrationCompanyType
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['BillingIntegrationCompanyType'], typing.List['BillingIntegrationCompanyType']],
                ...
                def __getitem__(self, i: int) -> 'BillingIntegrationCompanyType':
