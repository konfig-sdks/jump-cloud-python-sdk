...
class AutotaskRetrieveMappingsResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class records(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AutotaskMappingResponse']:
                        return AutotaskMappingResponse
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['AutotaskMappingResponse'], typing.List['AutotaskMappingResponse']],
                ...
                def __getitem__(self, i: int) -> 'AutotaskMappingResponse':
