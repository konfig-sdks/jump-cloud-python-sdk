...
class SystemInsightsLoggedInUsers(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["collection_time", "host", "pid", "system_id", "time", "tty", "type", "user", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["collection_time", "host", "pid", "system_id", "time", "tty", "type", "user", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        tty: typing.Union[MetaOapg.properties.tty, str, schemas.Unset] = schemas.unset,
