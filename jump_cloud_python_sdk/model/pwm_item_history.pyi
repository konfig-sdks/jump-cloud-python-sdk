...
class PwmItemHistory(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["createdBy", "dateCreated", "dateUpdated", "updatedBy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["createdBy", "dateCreated", "dateUpdated", "updatedBy", ], str]):
