...
class SystemInsightsUserSshKeys(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["collection_time", "encrypted", "path", "system_id", "uid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["collection_time", "encrypted", "path", "system_id", "uid", ], str]):
