...
class AutotaskRetrieveContractsResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['AutotaskContract']:
                        return AutotaskContract
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['AutotaskContract'], typing.List['AutotaskContract']],
                ...
                def __getitem__(self, i: int) -> 'AutotaskContract':
