...
class PolicyResult(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["detail", "endedAt", "exitStatus", "id", "policyID", "startedAt", "state", "stdErr", "stdOut", "success", "systemID", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["stdErr"]) -> typing.Union[MetaOapg.properties.stdErr, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["detail", "endedAt", "exitStatus", "id", "policyID", "startedAt", "state", "stdErr", "stdOut", "success", "systemID", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        exitStatus: typing.Union[MetaOapg.properties.exitStatus, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ...
        stdErr: typing.Union[MetaOapg.properties.stdErr, str, schemas.Unset] = schemas.unset,
