...
class SystemInsightsStartupItems(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["args", "name", "path", "source", "status", "system_id", "type", "username", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["args", "name", "path", "source", "status", "system_id", "type", "username", ], str]):
