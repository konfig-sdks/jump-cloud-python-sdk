...
class SystemInsightsAuthorizedKeys(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["algorithm", "collection_time", "key", "key_file", "system_id", "uid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["algorithm", "collection_time", "key", "key_file", "system_id", "uid", ], str]):
