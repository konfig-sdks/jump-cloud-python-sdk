...
class GoogleRpcStatus(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "details", "message", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "details", "message", ], str]):
