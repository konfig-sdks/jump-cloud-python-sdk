...
* `welcome` - Skips the Get Started pane.
    ...
    class MetaOapg:
        enum_value_to_name = {
            ...
            "fileVault": "FILE_VAULT",
            "icloudDiagnostics": "ICLOUD_DIAGNOSTICS",
            "icloudStorage": "ICLOUD_STORAGE",
            "location": "LOCATION",
            "payment": "PAYMENT",
            "privacy": "PRIVACY",
            "restore": "RESTORE",
            ...
            "deviceToDeviceMigration": "DEVICE_TO_DEVICE_MIGRATION",
            "homeButton": "HOME_BUTTON",
            "imessageAndFacetime": "IMESSAGE_AND_FACETIME",
            "messagingActivationUsingPhoneNumber": "MESSAGING_ACTIVATION_USING_PHONE_NUMBER",
            "moveFromAndroid": "MOVE_FROM_ANDROID",
            "passcode": "PASSCODE",
            "restoreComplete": "RESTORE_COMPLETE",
            "setupCellular": "SETUP_CELLULAR",
            "softwareUpdate": "SOFTWARE_UPDATE",
            "unlockWithWatch": "UNLOCK_WITH_WATCH",
            "updateComplete": "UPDATE_COMPLETE",
            "watchMigration": "WATCH_MIGRATION",
            "welcome": "WELCOME",
        }
    
    @schemas.classproperty
    def ACCESSIBILITY(cls):
    ...
    @schemas.classproperty
    def DISPLAY_TONE(cls):
        return cls("displayTone")
    
    @schemas.classproperty
    def FILE_VAULT(cls):
        return cls("fileVault")
    
    @schemas.classproperty
    def ICLOUD_DIAGNOSTICS(cls):
        return cls("icloudDiagnostics")
    
    @schemas.classproperty
    def ICLOUD_STORAGE(cls):
        return cls("icloudStorage")
    ...
    @schemas.classproperty
    def DISPLAY_ZOOM(cls):
        return cls("displayZoom")
    
    @schemas.classproperty
    def DEVICE_TO_DEVICE_MIGRATION(cls):
        return cls("deviceToDeviceMigration")
    
    @schemas.classproperty
    def HOME_BUTTON(cls):
        return cls("homeButton")
    
    @schemas.classproperty
    def IMESSAGE_AND_FACETIME(cls):
        return cls("imessageAndFacetime")
    
    @schemas.classproperty
    def MESSAGING_ACTIVATION_USING_PHONE_NUMBER(cls):
        return cls("messagingActivationUsingPhoneNumber")
    
    @schemas.classproperty
    def MOVE_FROM_ANDROID(cls):
        return cls("moveFromAndroid")
    ...
    @schemas.classproperty
    def RESTORE_COMPLETE(cls):
        return cls("restoreComplete")
    
    @schemas.classproperty
    def SETUP_CELLULAR(cls):
        return cls("setupCellular")
    
    @schemas.classproperty
    def SOFTWARE_UPDATE(cls):
        return cls("softwareUpdate")
    
    @schemas.classproperty
    def UNLOCK_WITH_WATCH(cls):
        return cls("unlockWithWatch")
    
    @schemas.classproperty
    def UPDATE_COMPLETE(cls):
        return cls("updateComplete")
    
    @schemas.classproperty
    def WATCH_MIGRATION(cls):
        return cls("watchMigration")
