...
class SystemInsightsKernelInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["version", "arguments", "collection_time", "device", "path", "system_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["version", "arguments", "collection_time", "device", "path", "system_id", ], str]):
