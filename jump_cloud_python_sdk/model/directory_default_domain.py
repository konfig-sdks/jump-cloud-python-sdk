...
class DirectoryDefaultDomain(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["domain", "id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["domain", "id", ], str]):
