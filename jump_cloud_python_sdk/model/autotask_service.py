...
class AutotaskService(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contractId", "id", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contractId", "id", "name", ], str]):
