...
class PwmItemsCountByType(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["count", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["count", "type", ], str]):
