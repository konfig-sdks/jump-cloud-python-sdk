...
class SuggestionCounts(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["add", "remove", "total", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["add", "remove", "total", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        add: typing.Union[MetaOapg.properties.add, decimal.Decimal, int, schemas.Unset] = schemas.unset,
