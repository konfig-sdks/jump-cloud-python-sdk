...
class Office365SListImportUsersResponseUsersItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["givenName", "id", "surname", "userPrincipalName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["givenName", "id", "surname", "userPrincipalName", ], str]):
    ...
    ) -> 'Office365SListImportUsersResponseUsersItem':
