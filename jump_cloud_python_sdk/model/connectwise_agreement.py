...
class ConnectwiseAgreement(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["companyId", "id", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["companyId", "id", "name", ], str]):
