...
class SyncroMappingRequestDataItemBillingConfigurationsFieldsScheduleName(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["kind", "stringValue", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["kind", "stringValue", ], str]):
    ...
    ) -> 'SyncroMappingRequestDataItemBillingConfigurationsFieldsScheduleName':
