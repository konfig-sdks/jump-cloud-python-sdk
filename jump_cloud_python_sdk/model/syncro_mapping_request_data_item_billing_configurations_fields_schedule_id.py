...
class SyncroMappingRequestDataItemBillingConfigurationsFieldsScheduleId(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["kind", "numberValue", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["kind", "numberValue", ], str]):
    ...
    ) -> 'SyncroMappingRequestDataItemBillingConfigurationsFieldsScheduleId':
