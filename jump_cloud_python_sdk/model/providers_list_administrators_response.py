...
class ProvidersListAdministratorsResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Administrator']:
                        return Administrator
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Administrator'], typing.List['Administrator']],
                ...
                def __getitem__(self, i: int) -> 'Administrator':
