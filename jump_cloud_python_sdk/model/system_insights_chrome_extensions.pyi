...
class SystemInsightsChromeExtensions(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["persistent"]) -> MetaOapg.properties.persistent: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "version", "author", "collection_time", "identifier", "locale", "name", "path", "permissions", "persistent", "system_id", "uid", "update_url", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["persistent"]) -> typing.Union[MetaOapg.properties.persistent, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "version", "author", "collection_time", "identifier", "locale", "name", "path", "permissions", "persistent", "system_id", "uid", "update_url", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        persistent: typing.Union[MetaOapg.properties.persistent, decimal.Decimal, int, schemas.Unset] = schemas.unset,
