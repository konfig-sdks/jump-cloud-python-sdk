...
class WorkdayFields(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "reportUrl", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "reportUrl", ], str]):
