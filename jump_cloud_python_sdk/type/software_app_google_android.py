...
from jump_cloud_python_sdk.type.software_app_google_android_android_features import SoftwareAppGoogleAndroidAndroidFeatures
from jump_cloud_python_sdk.type.software_app_permission_grants import SoftwareAppPermissionGrants

class RequiredSoftwareAppGoogleAndroid(TypedDict):
    pass

class OptionalSoftwareAppGoogleAndroid(TypedDict, total=False):
    androidFeatures: SoftwareAppGoogleAndroidAndroidFeatures
    ...
    managedConfigurationTemplateId: str

    # Indicates whether this app has managed properties or not.
    managedProperties: bool
    ...
    permissionGrants: typing.List[SoftwareAppPermissionGrants]
...
class SoftwareAppGoogleAndroid(RequiredSoftwareAppGoogleAndroid, OptionalSoftwareAppGoogleAndroid):
    pass
